...
public class ExpenseBiaya extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ExpenseBiaya.this, R.layout.support_simple_spinner_dropdown_item, regular);
        ...
        ArrayAdapter<String> arrayCurrency = new ArrayAdapter<String>(ExpenseBiaya.this, R.layout.support_simple_spinner_dropdown_item, unit);
        arrayAdapter.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
        currency_sp.setAdapter(arrayCurrency);
        date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(ExpenseBiaya.this, dateSetListener, myCalender.get(Calendar.YEAR), myCalender.get(Calendar.MONTH), myCalender.get(Calendar.DATE)).show();
            }
        });
        ...
        databaseClass = new DatabaseClass(ExpenseBiaya.this);
        saveTodatabase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(ExpenseBiaya.this, "Saved New Expense Record", Toast.LENGTH_LONG).show();
    ...
    private void openImageChooser() {
        verifyStoragePermissions(ExpenseBiaya.this);
